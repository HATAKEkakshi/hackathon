...
class InvertedLists(object):
    ...
    use_iterator = property(_swigfaiss.InvertedLists_use_iterator_get, _swigfaiss.InvertedLists_use_iterator_set)
...
class HNSW(object):
    ...
    def search_level_0(self, qdis, res, nprobe, nearest_i, nearest_d, search_type, search_stats, vt):
        ...
        return _swigfaiss.HNSW_search_level_0(self, qdis, res, nprobe, nearest_i, nearest_d, search_type, search_stats, vt)
...
class IndexIVFFastScan(IndexIVF):
    ...
    def search_dispatch_implem(self, n, x, k, distances, labels, cq, scaler):
        return _swigfaiss.IndexIVFFastScan_search_dispatch_implem(self, n, x, k, distances, labels, cq, scaler)

    def range_search_dispatch_implem(self, n, x, radius, rres, cq_in, scaler):
        return _swigfaiss.IndexIVFFastScan_range_search_dispatch_implem(self, n, x, radius, rres, cq_in, scaler)

    def search_implem_10(self, n, x, handler, cq, ndis_out, nlist_out, scaler):
        return _swigfaiss.IndexIVFFastScan_search_implem_10(self, n, x, handler, cq, ndis_out, nlist_out, scaler)

    def search_implem_12(self, n, x, handler, cq, ndis_out, nlist_out, scaler):
        return _swigfaiss.IndexIVFFastScan_search_implem_12(self, n, x, handler, cq, ndis_out, nlist_out, scaler)

    def search_implem_14(self, n, x, k, distances, labels, cq, impl, scaler):
        return _swigfaiss.IndexIVFFastScan_search_implem_14(self, n, x, k, distances, labels, cq, impl, scaler)
